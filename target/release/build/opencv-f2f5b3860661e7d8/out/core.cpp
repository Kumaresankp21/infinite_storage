...
extern "C" {
	...
	void cv_abs_const_MatExprR(const cv::MatExpr* e, Result<cv::MatExpr*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::MatExpr*>, ocvrs_return);
	}
	...
	void cv_detail_check_failed_auto_const_Size_LintG_const_CheckContextR(const cv::Size_<int>* v, const cv::detail::CheckContext* ctx, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_check_failed_auto_const_Size_LintG_const_Size_LintG_const_CheckContextR(const cv::Size_<int>* v1, const cv::Size_<int>* v2, const cv::detail::CheckContext* ctx, Result_void* ocvrs_return) {
		try {
	...
	void cv_glob_String_vectorLStringGR_bool(char* pattern, std::vector<cv::String>* result, bool recursive, Result_void* ocvrs_return) {
		try {
	...
	void cv_instr_getFlags(Result<cv::instr::FLAGS>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::instr::FLAGS>, ocvrs_return);
	}
	...
	void cv_ipp_getIppFeatures(Result<unsigned long long>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<unsigned long long>, ocvrs_return);
	}
	...
	void cv_mixChannels_const__InputArrayR_const__InputOutputArrayR_const_vectorLintGR(const cv::_InputArray* src, const cv::_InputOutputArray* dst, const std::vector<int>* fromTo, Result_void* ocvrs_return) {
		try {
	...
	void cv_ocl_convertTypeStr_int_int_int_charX(int sdepth, int ddepth, int cn, void** buf, Result<void*>* ocvrs_return) {
		try {
			...
			*buf = ocvrs_create_string(buf_out);
			void* ret_1 = ocvrs_create_string(ret);
			delete[] buf_out;
	...
	void cv_ocl_getPlatfomsInfo_vectorLPlatformInfoGR(std::vector<cv::ocl::PlatformInfo>* platform_info, Result_void* ocvrs_return) {
		try {
	...
	void cv_ogl_ocl_initializeContextFromGL(Result<cv::ocl::Context*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::ocl::Context*>, ocvrs_return);
	}
	...
	void cv_ogl_render_const_Texture2DR_Rect_LdoubleG_Rect_LdoubleG(const cv::ogl::Texture2D* tex, cv::Rect_<double>* wndRect, cv::Rect_<double>* texRect, Result_void* ocvrs_return) {
		try {
	...
	void cv_read_const_FileNodeR_vectorLDMatchGR(const cv::FileNode* node, std::vector<cv::DMatch>* matches, Result_void* ocvrs_return) {
		try {
	...
	void cv_read_const_FileNodeR_vectorLKeyPointGR(const cv::FileNode* node, std::vector<cv::KeyPoint>* keypoints, Result_void* ocvrs_return) {
		try {
	...
	void cv_theRNG(Result<cv::RNG*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::RNG*>, ocvrs_return);
	}
	...
	void cv_utils_generateVectorOfInt_size_t_vectorLintGR(size_t len, std::vector<int>* vec, Result_void* ocvrs_return) {
		try {
	...
	void cv_utils_generateVectorOfMat_size_t_int_int_int_vectorLMatGR(size_t len, int rows, int cols, int dtype, std::vector<cv::Mat>* vec, Result_void* ocvrs_return) {
		try {
	...
	void cv_utils_generateVectorOfRect_size_t_vectorLRectGR(size_t len, std::vector<cv::Rect>* vec, Result_void* ocvrs_return) {
		try {
	...
	void cv_utils_logging_getLogLevel(Result<cv::utils::logging::LogLevel>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::utils::logging::LogLevel>, ocvrs_return);
	}
	...
	void cv_utils_logging_internal_getGlobalLogTag(Result<cv::utils::logging::LogTag**>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::utils::logging::LogTag**>, ocvrs_return);
	}
	...
	void cv_write_FileStorageR_const_StringR_const_vectorLDMatchGR(cv::FileStorage* fs, const char* name, const std::vector<cv::DMatch>* value, Result_void* ocvrs_return) {
		try {
			cv::write(*fs, std::string(name), *value);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_write_FileStorageR_const_StringR_const_vectorLKeyPointGR(cv::FileStorage* fs, const char* name, const std::vector<cv::KeyPoint>* value, Result_void* ocvrs_return) {
		try {
			cv::write(*fs, std::string(name), *value);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_Algorithm_Algorithm(Result<cv::Algorithm*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::Algorithm*>, ocvrs_return);
	}
	...
	void cv_Algorithm_write_const_const_PtrLFileStorageGR_const_StringR(const cv::Algorithm* instance, const cv::Ptr<cv::FileStorage>* fs, const char* name, Result_void* ocvrs_return) {
		try {
	...
	void cv_AsyncPromise_AsyncPromise_AsyncPromiseRR(cv::AsyncPromise* o, Result<cv::AsyncPromise*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::AsyncPromise*>, ocvrs_return);
	}
	...
	void cv_CommandLineParser_CommandLineParser_int_const_charXX_const_StringR(int argc, const char** argv, const char* keys, Result<cv::CommandLineParser*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::CommandLineParser*>, ocvrs_return);
	}
	...
	void cv_ConjGradSolver_create_const_PtrLFunctionGR_TermCriteria(const cv::Ptr<cv::MinProblemSolver::Function>* f, cv::TermCriteria* termcrit, Result<cv::Ptr<cv::ConjGradSolver>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::ConjGradSolver>*>, ocvrs_return);
	}
	...
	void cv_DMatch_DMatch(Result<cv::DMatch>* ocvrs_return) {
		try {
			cv::DMatch ret;
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::DMatch>, ocvrs_return);
	}
	...
	void cv_DownhillSolver_create_const_PtrLFunctionGR_const__InputArrayR_TermCriteria(const cv::Ptr<cv::MinProblemSolver::Function>* f, const cv::_InputArray* initStep, cv::TermCriteria* termcrit, Result<cv::Ptr<cv::DownhillSolver>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::DownhillSolver>*>, ocvrs_return);
	}
	...
	void cv_Exception_Exception(Result<cv::Exception*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::Exception*>, ocvrs_return);
	}
	...
	void cv_FileNode_FileNode(Result<cv::FileNode*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::FileNode*>, ocvrs_return);
	}
	...
	void cv_FileNode_ptr_const(const cv::FileNode* instance, Result<const unsigned char*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<const unsigned char*>, ocvrs_return);
	}
	...
	void cv_FileNode_begin_const(const cv::FileNode* instance, Result<cv::FileNodeIterator*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::FileNodeIterator*>, ocvrs_return);
	}
	...
	void cv_FileStorage_FileStorage(Result<cv::FileStorage*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::FileStorage*>, ocvrs_return);
	}
	...
	void cv_FileStorage_write_const_StringR_const_vectorLStringGR(cv::FileStorage* instance, const char* name, const std::vector<cv::String>* val, Result_void* ocvrs_return) {
		try {
			instance->write(std::string(name), *val);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_Formatter_format_const_const_MatR(const cv::Formatter* instance, const cv::Mat* mtx, Result<cv::Ptr<cv::Formatted>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::Formatted>*>, ocvrs_return);
	}
	...
	void cv_Formatter_get_FormatType(cv::Formatter::FormatType fmt, Result<cv::Ptr<cv::Formatter>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::Formatter>*>, ocvrs_return);
	}
	...
	void cv_Hamming_operator___const_const_unsigned_charX_const_unsigned_charX_int(const cv::Hamming* instance, const unsigned char* a, const unsigned char* b, int size, Result<cv::Hamming::ResultType>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::Hamming::ResultType>, ocvrs_return);
	}
	
	void cv_KeyPoint_getPropPt_const(const cv::KeyPoint* instance, cv::Point2f* ocvrs_return) {
			cv::Point2f ret = instance->pt;
			*ocvrs_return = ret;
	}
	
	void cv_KeyPoint_setPropPt_Point2f(cv::KeyPoint* instance, cv::Point2f* val) {
			instance->pt = *val;
	}
	
	float cv_KeyPoint_getPropSize_const(const cv::KeyPoint* instance) {
			float ret = instance->size;
			return ret;
	}
	
	void cv_KeyPoint_setPropSize_float(cv::KeyPoint* instance, float val) {
			instance->size = val;
	}
	
	float cv_KeyPoint_getPropAngle_const(const cv::KeyPoint* instance) {
			float ret = instance->angle;
			return ret;
	}
	
	void cv_KeyPoint_setPropAngle_float(cv::KeyPoint* instance, float val) {
			instance->angle = val;
	}
	
	float cv_KeyPoint_getPropResponse_const(const cv::KeyPoint* instance) {
			float ret = instance->response;
			return ret;
	}
	
	void cv_KeyPoint_setPropResponse_float(cv::KeyPoint* instance, float val) {
			instance->response = val;
	}
	
	int cv_KeyPoint_getPropOctave_const(const cv::KeyPoint* instance) {
			int ret = instance->octave;
			return ret;
	}
	
	void cv_KeyPoint_setPropOctave_int(cv::KeyPoint* instance, int val) {
			instance->octave = val;
	}
	
	int cv_KeyPoint_getPropClass_id_const(const cv::KeyPoint* instance) {
			int ret = instance->class_id;
			return ret;
	}
	
	void cv_KeyPoint_setPropClass_id_int(cv::KeyPoint* instance, int val) {
	...
	void cv_KeyPoint_KeyPoint(Result<cv::KeyPoint*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::KeyPoint*>, ocvrs_return);
	}
	...
	void cv_KeyPoint_convert_const_vectorLKeyPointGR_vectorLPoint2fGR_const_vectorLintGR(const std::vector<cv::KeyPoint>* keypoints, std::vector<cv::Point2f>* points2f, const std::vector<int>* keypointIndexes, Result_void* ocvrs_return) {
		try {
	...
	void cv_KeyPoint_convert_const_vectorLPoint2fGR_vectorLKeyPointGR_float_float_int_int(const std::vector<cv::Point2f>* points2f, std::vector<cv::KeyPoint>* keypoints, float size, float response, int octave, int class_id, Result_void* ocvrs_return) {
		try {
	...
	void cv_LDA_LDA_int(int num_components, Result<cv::LDA*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::LDA*>, ocvrs_return);
	}
	...
	void cv_Mat_create_const_vectorLintGR_int(cv::Mat* instance, const std::vector<int>* sizes, int type, Result_void* ocvrs_return) {
		try {
	...
	void cv_Mat_Mat_MatRR(cv::Mat* m, Result<cv::Mat*>* ocvrs_return) {
		try {
	...
	void cv_MatConstIterator_MatConstIterator(Result<cv::MatConstIterator*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::MatConstIterator*>, ocvrs_return);
	}
	...
	void cv_MatConstIterator_lpos_const(const cv::MatConstIterator* instance, Result<ptrdiff_t>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<ptrdiff_t>, ocvrs_return);
	}
	...
	void cv_Matx_AddOp_Matx_AddOp(Result<cv::Matx_AddOp*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::Matx_AddOp*>, ocvrs_return);
	}
	...
	void cv_Matx_DivOp_Matx_DivOp(Result<cv::Matx_DivOp*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::Matx_DivOp*>, ocvrs_return);
	}
	...
	void cv_Matx_MatMulOp_Matx_MatMulOp(Result<cv::Matx_MatMulOp*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::Matx_MatMulOp*>, ocvrs_return);
	}
	...
	void cv_Matx_MulOp_Matx_MulOp(Result<cv::Matx_MulOp*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::Matx_MulOp*>, ocvrs_return);
	}
	...
	void cv_Matx_ScaleOp_Matx_ScaleOp(Result<cv::Matx_ScaleOp*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::Matx_ScaleOp*>, ocvrs_return);
	}
	...
	void cv_Matx_SubOp_Matx_SubOp(Result<cv::Matx_SubOp*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::Matx_SubOp*>, ocvrs_return);
	}
	...
	void cv_Matx_TOp_Matx_TOp(Result<cv::Matx_TOp*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::Matx_TOp*>, ocvrs_return);
	}
	...
	void cv_MinProblemSolver_getFunction_const(const cv::MinProblemSolver* instance, Result<cv::Ptr<cv::MinProblemSolver::Function>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::MinProblemSolver::Function>*>, ocvrs_return);
	}
	
	void cv_MinProblemSolver_setFunction_const_PtrLFunctionGR(cv::MinProblemSolver* instance, const cv::Ptr<cv::MinProblemSolver::Function>* f, Result_void* ocvrs_return) {
		try {
	...
	void cv_PCA_PCA(Result<cv::PCA*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::PCA*>, ocvrs_return);
	}
	...
	void cv_ParallelLoopBody_operator___const_const_RangeR(const cv::ParallelLoopBody* instance, const cv::Range* range, Result_void* ocvrs_return) {
		try {
	...
	void cv_RNG_next(cv::RNG* instance, Result<unsigned int>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<unsigned int>, ocvrs_return);
	}
	...
	void cv_RNG_operator_signed_char(cv::RNG* instance, Result<signed char>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<signed char>, ocvrs_return);
	}
	...
	void cv_RNG_operator_unsigned_short(cv::RNG* instance, Result<unsigned short>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<unsigned short>, ocvrs_return);
	}
	...
	void cv_RNG_operator_short(cv::RNG* instance, Result<short>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<short>, ocvrs_return);
	}
	...
	void cv_RNG_MT19937_RNG_MT19937(Result<cv::RNG_MT19937*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::RNG_MT19937*>, ocvrs_return);
	}
	...
	void cv_Range_Range(Result<cv::Range*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::Range*>, ocvrs_return);
	}
	...
	void cv_RotatedRect_boundingRect2f_const(const cv::RotatedRect* instance, Result<cv::Rect_<float>>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::Rect_<float>>, ocvrs_return);
	}
	...
	void cv_SVD_SVD(Result<cv::SVD*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::SVD*>, ocvrs_return);
	}
	...
	void cv_SparseMat_SparseMat(Result<cv::SparseMat*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::SparseMat*>, ocvrs_return);
	}
	...
	void cv_SparseMat_size_const(const cv::SparseMat* instance, Result<const int*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<const int*>, ocvrs_return);
	}
	...
	void cv_SparseMat_begin(cv::SparseMat* instance, Result<cv::SparseMatIterator*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::SparseMatIterator*>, ocvrs_return);
	}
	...
	void cv_SparseMat_begin_const(const cv::SparseMat* instance, Result<cv::SparseMatConstIterator*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::SparseMatConstIterator*>, ocvrs_return);
	}
	...
	void cv_SparseMat_node_size_t(cv::SparseMat* instance, size_t nidx, Result<cv::SparseMat::Node**>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::SparseMat::Node**>, ocvrs_return);
	}
	...
	void cv_SparseMat_node_const_size_t(const cv::SparseMat* instance, size_t nidx, Result<const cv::SparseMat::Node**>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<const cv::SparseMat::Node**>, ocvrs_return);
	}
	...
	void cv_SparseMat_Hdr_setPropPool_vectorLunsigned_charG(cv::SparseMat::Hdr* instance, std::vector<unsigned char>* val) {
			instance->pool = *val;
	}
	...
	void cv_SparseMat_Hdr_setPropHashtab_vectorLsize_tG(cv::SparseMat::Hdr* instance, std::vector<size_t>* val) {
	...
	void cv_SparseMat_Hdr_Hdr_int_const_intX_int(int _dims, const int* _sizes, int _type, Result<cv::SparseMat::Hdr*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::SparseMat::Hdr*>, ocvrs_return);
	}
	...
	void cv_TickMeter_TickMeter(Result<cv::TickMeter*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::TickMeter*>, ocvrs_return);
	}
	...
	void cv_UMat_create_const_vectorLintGR_int_UMatUsageFlags(cv::UMat* instance, const std::vector<int>* sizes, int type, cv::UMatUsageFlags usageFlags, Result_void* ocvrs_return) {
		try {
	...
	void cv__InputArray_getMatVector_const_vectorLMatGR(const cv::_InputArray* instance, std::vector<cv::Mat>* mv, Result_void* ocvrs_return) {
		try {
	...
	void cv__InputArray_getUMatVector_const_vectorLUMatGR(const cv::_InputArray* instance, std::vector<cv::UMat>* umv, Result_void* ocvrs_return) {
		try {
	...
	void cv__InputArray_getGpuMatVector_const_vectorLGpuMatGR(const cv::_InputArray* instance, std::vector<cv::cuda::GpuMat>* gpumv, Result_void* ocvrs_return) {
		try {
	...
	void cv__InputArray_getGpuMat_const(const cv::_InputArray* instance, Result<cv::cuda::GpuMat*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::cuda::GpuMat*>, ocvrs_return);
	}
	...
	void cv__InputArray_getOGlBuffer_const(const cv::_InputArray* instance, Result<cv::ogl::Buffer*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::ogl::Buffer*>, ocvrs_return);
	}
	...
	void cv__InputArray_kind_const(const cv::_InputArray* instance, Result<cv::_InputArray::KindFlag>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::_InputArray::KindFlag>, ocvrs_return);
	}
	...
	#if !defined(OCVRS_TARGET_OS_WINDOWS)
	void cv__OutputArray__OutputArray_const_vectorLGpuMatGR(const std::vector<cv::cuda::GpuMat>* d_mat, Result<cv::_OutputArray*>* ocvrs_return) {
		try {
			cv::_OutputArray* ret = new cv::_OutputArray(*d_mat);
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::_OutputArray*>, ocvrs_return);
	...
	void cv__OutputArray_getGpuMatVecRef_const(const cv::_OutputArray* instance, Result<std::vector<cv::cuda::GpuMat>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<std::vector<cv::cuda::GpuMat>*>, ocvrs_return);
	}
	...
	void cv__OutputArray_getHostMemRef_const(const cv::_OutputArray* instance, Result<cv::cuda::HostMem*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::cuda::HostMem*>, ocvrs_return);
	}
	...
	void cv__OutputArray_assign_const_const_vectorLUMatGR(const cv::_OutputArray* instance, const std::vector<cv::UMat>* v, Result_void* ocvrs_return) {
		try {
			instance->assign(*v);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv__OutputArray_assign_const_const_vectorLMatGR(const cv::_OutputArray* instance, const std::vector<cv::Mat>* v, Result_void* ocvrs_return) {
		try {
			instance->assign(*v);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_cuda_BufferPool_BufferPool_StreamR(cv::cuda::Stream* stream, Result<cv::cuda::BufferPool*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::cuda::BufferPool*>, ocvrs_return);
	}
	...
	void cv_cuda_BufferPool_getAllocator_const(const cv::cuda::BufferPool* instance, Result<cv::Ptr<cv::cuda::GpuMat::Allocator>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::cuda::GpuMat::Allocator>*>, ocvrs_return);
	}
	...
	void cv_cuda_DeviceInfo_DeviceInfo(Result<cv::cuda::DeviceInfo*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::cuda::DeviceInfo*>, ocvrs_return);
	}
	...
	void cv_cuda_DeviceInfo_maxThreadsDim_const(const cv::cuda::DeviceInfo* instance, Result<cv::Vec3i>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::Vec3i>, ocvrs_return);
	}
	...
	void cv_cuda_DeviceInfo_computeMode_const(const cv::cuda::DeviceInfo* instance, Result<cv::cuda::DeviceInfo::ComputeMode>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::cuda::DeviceInfo::ComputeMode>, ocvrs_return);
	}
	...
	void cv_cuda_DeviceInfo_maxTexture2D_const(const cv::cuda::DeviceInfo* instance, Result<cv::Vec2i>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::Vec2i>, ocvrs_return);
	}
	...
	void cv_cuda_Event_Event_CreateFlags(cv::cuda::Event::CreateFlags flags, Result<cv::cuda::Event*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::cuda::Event*>, ocvrs_return);
	}
	...
	void cv_cuda_GpuData_GpuData_size_t(size_t _size, Result<cv::cuda::GpuData*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::cuda::GpuData*>, ocvrs_return);
	}
	...
	void cv_cuda_GpuMat_defaultAllocator(Result<cv::cuda::GpuMat::Allocator*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::cuda::GpuMat::Allocator*>, ocvrs_return);
	}
	...
	void cv_cuda_GpuMatND_GpuMatND(Result<cv::cuda::GpuMatND*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::cuda::GpuMatND*>, ocvrs_return);
	}
	...
	void cv_cuda_Stream_Stream(Result<cv::cuda::Stream*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::cuda::Stream*>, ocvrs_return);
	}
	...
	void cv_instr_NodeData_NodeData_const_charX_const_charX_int_voidX_bool_TYPE_IMPL(const char* funName, const char* fileName, int lineNum, void* retAddress, bool alwaysExpand, cv::instr::TYPE instrType, cv::instr::IMPL implType, Result<cv::instr::NodeData*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::instr::NodeData*>, ocvrs_return);
	}
	...
	void cv_internal_WriteStructContext_WriteStructContext_FileStorageR_const_StringR_int_const_StringR(cv::FileStorage* _fs, const char* name, int flags, const char* typeName, Result<cv::internal::WriteStructContext*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::internal::WriteStructContext*>, ocvrs_return);
	}
	...
	void cv_ocl_Context_device_const_size_t(const cv::ocl::Context* instance, size_t idx, Result<cv::ocl::Device*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::ocl::Device*>, ocvrs_return);
	}
	...
	void cv_ocl_Context_getProg_const_ProgramSourceR_const_StringR_StringR(cv::ocl::Context* instance, const cv::ocl::ProgramSource* prog, const char* buildopt, void** errmsg, Result<cv::ocl::Program*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::ocl::Program*>, ocvrs_return);
	}
	...
	void cv_ocl_Image2D_Image2D_const_UMatR_bool_bool(const cv::UMat* src, bool norm, bool alias, Result<cv::ocl::Image2D*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::ocl::Image2D*>, ocvrs_return);
	}
	...
	void cv_ocl_Kernel_Kernel_const_charX_const_ProgramR(const char* kname, const cv::ocl::Program* prog, Result<cv::ocl::Kernel*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::ocl::Kernel*>, ocvrs_return);
	}
	...
	void cv_ocl_KernelArg_KernelArg_int_UMatX_int_int_const_voidX_size_t(int _flags, cv::UMat* _m, int wscale, int iwscale, const void* _obj, size_t _sz, Result<cv::ocl::KernelArg*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::ocl::KernelArg*>, ocvrs_return);
	}
	...
	void cv_ocl_OpenCLExecutionContext_getQueue_const(const cv::ocl::OpenCLExecutionContext* instance, Result<cv::ocl::Queue*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::ocl::Queue*>, ocvrs_return);
	}
	...
	void cv_ocl_OpenCLExecutionContext_getCurrent(Result<cv::ocl::OpenCLExecutionContext*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::ocl::OpenCLExecutionContext*>, ocvrs_return);
	}
	...
	void cv_ocl_Platform_Platform_const_PlatformR(const cv::ocl::Platform* p, Result<cv::ocl::Platform*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::ocl::Platform*>, ocvrs_return);
	}
	...
	void cv_ocl_PlatformInfo_PlatformInfo_voidX(void* id, Result<cv::ocl::PlatformInfo*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::ocl::PlatformInfo*>, ocvrs_return);
	}
	...
	void cv_ocl_Program_getBinary_const_vectorLcharGR(const cv::ocl::Program* instance, std::vector<char>* binary, Result_void* ocvrs_return) {
		try {
	...
	void cv_ocl_Program_source_const(const cv::ocl::Program* instance, Result<cv::ocl::ProgramSource*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::ocl::ProgramSource*>, ocvrs_return);
	}
	...
	void cv_ocl_ProgramSource_hash_const(const cv::ocl::ProgramSource* instance, Result<cv::ocl::ProgramSource::hash_t>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::ocl::ProgramSource::hash_t>, ocvrs_return);
	}
	...
	void cv_ocl_Timer_Timer_const_QueueR(const cv::ocl::Queue* q, Result<cv::ocl::Timer*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::ocl::Timer*>, ocvrs_return);
	}
	...
	void cv_ocl_Timer_durationNS_const(const cv::ocl::Timer* instance, Result<uint64_t>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<uint64_t>, ocvrs_return);
	}
	...
	void cv_ogl_Arrays_Arrays(Result<cv::ogl::Arrays*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::ogl::Arrays*>, ocvrs_return);
	}
	...
	void cv_ogl_Texture2D_Texture2D(Result<cv::ogl::Texture2D*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::ogl::Texture2D*>, ocvrs_return);
	}
	...
	void cv_ogl_Texture2D_format_const(const cv::ogl::Texture2D* instance, Result<cv::ogl::Texture2D::Format>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::ogl::Texture2D::Format>, ocvrs_return);
	}
