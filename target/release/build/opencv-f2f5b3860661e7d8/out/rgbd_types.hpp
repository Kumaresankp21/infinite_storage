...
extern "C" {
	cv::Ptr<cv::colored_kinfu::Params>* cv_PtrOfColoredKinfu_Params_new(cv::colored_kinfu::Params* val) {
			cv::Ptr<cv::colored_kinfu::Params> ret = cv::Ptr<cv::colored_kinfu::Params>(val);
			return new cv::Ptr<cv::colored_kinfu::Params>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::rgbd::DepthCleaner>* cv_PtrOfDepthCleaner_new(cv::rgbd::DepthCleaner* val) {
			cv::Ptr<cv::rgbd::DepthCleaner> ret = cv::Ptr<cv::rgbd::DepthCleaner>(val);
			return new cv::Ptr<cv::rgbd::DepthCleaner>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::rgbd::FastICPOdometry>* cv_PtrOfFastICPOdometry_new(cv::rgbd::FastICPOdometry* val) {
			cv::Ptr<cv::rgbd::FastICPOdometry> ret = cv::Ptr<cv::rgbd::FastICPOdometry>(val);
			return new cv::Ptr<cv::rgbd::FastICPOdometry>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::rgbd::ICPOdometry>* cv_PtrOfICPOdometry_new(cv::rgbd::ICPOdometry* val) {
			cv::Ptr<cv::rgbd::ICPOdometry> ret = cv::Ptr<cv::rgbd::ICPOdometry>(val);
			return new cv::Ptr<cv::rgbd::ICPOdometry>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::kinfu::Params>* cv_PtrOfKinfu_Params_new(cv::kinfu::Params* val) {
			cv::Ptr<cv::kinfu::Params> ret = cv::Ptr<cv::kinfu::Params>(val);
			return new cv::Ptr<cv::kinfu::Params>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::kinfu::VolumeParams>* cv_PtrOfKinfu_VolumeParams_new(cv::kinfu::VolumeParams* val) {
			cv::Ptr<cv::kinfu::VolumeParams> ret = cv::Ptr<cv::kinfu::VolumeParams>(val);
			return new cv::Ptr<cv::kinfu::VolumeParams>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::linemod::ColorGradient>* cv_PtrOfLinemod_ColorGradient_new(cv::linemod::ColorGradient* val) {
			cv::Ptr<cv::linemod::ColorGradient> ret = cv::Ptr<cv::linemod::ColorGradient>(val);
			return new cv::Ptr<cv::linemod::ColorGradient>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::linemod::DepthNormal>* cv_PtrOfLinemod_DepthNormal_new(cv::linemod::DepthNormal* val) {
			cv::Ptr<cv::linemod::DepthNormal> ret = cv::Ptr<cv::linemod::DepthNormal>(val);
			return new cv::Ptr<cv::linemod::DepthNormal>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::linemod::Detector>* cv_PtrOfLinemod_Detector_new(cv::linemod::Detector* val) {
			cv::Ptr<cv::linemod::Detector> ret = cv::Ptr<cv::linemod::Detector>(val);
			return new cv::Ptr<cv::linemod::Detector>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::rgbd::OdometryFrame>* cv_PtrOfOdometryFrame_new(cv::rgbd::OdometryFrame* val) {
			cv::Ptr<cv::rgbd::OdometryFrame> ret = cv::Ptr<cv::rgbd::OdometryFrame>(val);
			return new cv::Ptr<cv::rgbd::OdometryFrame>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::large_kinfu::Params>* cv_PtrOfParams_new(cv::large_kinfu::Params* val) {
			cv::Ptr<cv::large_kinfu::Params> ret = cv::Ptr<cv::large_kinfu::Params>(val);
			return new cv::Ptr<cv::large_kinfu::Params>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::rgbd::RgbdFrame>* cv_PtrOfRgbdFrame_new(cv::rgbd::RgbdFrame* val) {
			cv::Ptr<cv::rgbd::RgbdFrame> ret = cv::Ptr<cv::rgbd::RgbdFrame>(val);
			return new cv::Ptr<cv::rgbd::RgbdFrame>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::rgbd::RgbdICPOdometry>* cv_PtrOfRgbdICPOdometry_new(cv::rgbd::RgbdICPOdometry* val) {
			cv::Ptr<cv::rgbd::RgbdICPOdometry> ret = cv::Ptr<cv::rgbd::RgbdICPOdometry>(val);
			return new cv::Ptr<cv::rgbd::RgbdICPOdometry>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::rgbd::RgbdNormals>* cv_PtrOfRgbdNormals_new(cv::rgbd::RgbdNormals* val) {
			cv::Ptr<cv::rgbd::RgbdNormals> ret = cv::Ptr<cv::rgbd::RgbdNormals>(val);
			return new cv::Ptr<cv::rgbd::RgbdNormals>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::rgbd::RgbdOdometry>* cv_PtrOfRgbdOdometry_new(cv::rgbd::RgbdOdometry* val) {
			cv::Ptr<cv::rgbd::RgbdOdometry> ret = cv::Ptr<cv::rgbd::RgbdOdometry>(val);
			return new cv::Ptr<cv::rgbd::RgbdOdometry>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::rgbd::RgbdPlane>* cv_PtrOfRgbdPlane_new(cv::rgbd::RgbdPlane* val) {
			cv::Ptr<cv::rgbd::RgbdPlane> ret = cv::Ptr<cv::rgbd::RgbdPlane>(val);
			return new cv::Ptr<cv::rgbd::RgbdPlane>(ret);
	}
