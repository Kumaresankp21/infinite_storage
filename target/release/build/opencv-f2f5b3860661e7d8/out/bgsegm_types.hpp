...
extern "C" {
	cv::Ptr<cv::bgsegm::SyntheticSequenceGenerator>* cv_PtrOfSyntheticSequenceGenerator_new(cv::bgsegm::SyntheticSequenceGenerator* val) {
			cv::Ptr<cv::bgsegm::SyntheticSequenceGenerator> ret = cv::Ptr<cv::bgsegm::SyntheticSequenceGenerator>(val);
			return new cv::Ptr<cv::bgsegm::SyntheticSequenceGenerator>(ret);
	}
