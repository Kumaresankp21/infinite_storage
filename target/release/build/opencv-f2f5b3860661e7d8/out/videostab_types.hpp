extern "C" {
	cv::Ptr<cv::videostab::ColorAverageInpainter>* cv_PtrOfColorAverageInpainter_new(cv::videostab::ColorAverageInpainter* val) {
			cv::Ptr<cv::videostab::ColorAverageInpainter> ret = cv::Ptr<cv::videostab::ColorAverageInpainter>(val);
			return new cv::Ptr<cv::videostab::ColorAverageInpainter>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::ColorInpainter>* cv_PtrOfColorInpainter_new(cv::videostab::ColorInpainter* val) {
			cv::Ptr<cv::videostab::ColorInpainter> ret = cv::Ptr<cv::videostab::ColorInpainter>(val);
			return new cv::Ptr<cv::videostab::ColorInpainter>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::ConsistentMosaicInpainter>* cv_PtrOfConsistentMosaicInpainter_new(cv::videostab::ConsistentMosaicInpainter* val) {
			cv::Ptr<cv::videostab::ConsistentMosaicInpainter> ret = cv::Ptr<cv::videostab::ConsistentMosaicInpainter>(val);
			return new cv::Ptr<cv::videostab::ConsistentMosaicInpainter>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::FromFileMotionReader>* cv_PtrOfFromFileMotionReader_new(cv::videostab::FromFileMotionReader* val) {
			cv::Ptr<cv::videostab::FromFileMotionReader> ret = cv::Ptr<cv::videostab::FromFileMotionReader>(val);
			return new cv::Ptr<cv::videostab::FromFileMotionReader>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::GaussianMotionFilter>* cv_PtrOfGaussianMotionFilter_new(cv::videostab::GaussianMotionFilter* val) {
			cv::Ptr<cv::videostab::GaussianMotionFilter> ret = cv::Ptr<cv::videostab::GaussianMotionFilter>(val);
			return new cv::Ptr<cv::videostab::GaussianMotionFilter>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::InpaintingPipeline>* cv_PtrOfInpaintingPipeline_new(cv::videostab::InpaintingPipeline* val) {
			cv::Ptr<cv::videostab::InpaintingPipeline> ret = cv::Ptr<cv::videostab::InpaintingPipeline>(val);
			return new cv::Ptr<cv::videostab::InpaintingPipeline>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::KeypointBasedMotionEstimator>* cv_PtrOfKeypointBasedMotionEstimator_new(cv::videostab::KeypointBasedMotionEstimator* val) {
			cv::Ptr<cv::videostab::KeypointBasedMotionEstimator> ret = cv::Ptr<cv::videostab::KeypointBasedMotionEstimator>(val);
			return new cv::Ptr<cv::videostab::KeypointBasedMotionEstimator>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::LogToStdout>* cv_PtrOfLogToStdout_new(cv::videostab::LogToStdout* val) {
			cv::Ptr<cv::videostab::LogToStdout> ret = cv::Ptr<cv::videostab::LogToStdout>(val);
			return new cv::Ptr<cv::videostab::LogToStdout>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::LpMotionStabilizer>* cv_PtrOfLpMotionStabilizer_new(cv::videostab::LpMotionStabilizer* val) {
			cv::Ptr<cv::videostab::LpMotionStabilizer> ret = cv::Ptr<cv::videostab::LpMotionStabilizer>(val);
			return new cv::Ptr<cv::videostab::LpMotionStabilizer>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::MaskFrameSource>* cv_PtrOfMaskFrameSource_new(cv::videostab::MaskFrameSource* val) {
			cv::Ptr<cv::videostab::MaskFrameSource> ret = cv::Ptr<cv::videostab::MaskFrameSource>(val);
			return new cv::Ptr<cv::videostab::MaskFrameSource>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::MoreAccurateMotionWobbleSuppressor>* cv_PtrOfMoreAccurateMotionWobbleSuppressor_new(cv::videostab::MoreAccurateMotionWobbleSuppressor* val) {
			cv::Ptr<cv::videostab::MoreAccurateMotionWobbleSuppressor> ret = cv::Ptr<cv::videostab::MoreAccurateMotionWobbleSuppressor>(val);
			return new cv::Ptr<cv::videostab::MoreAccurateMotionWobbleSuppressor>(ret);
	}
	
	void cv_PtrOfMoreAccurateMotionWobbleSuppressor_delete(cv::Ptr<cv::videostab::MoreAccurateMotionWobbleSuppressor>* instance) {
			delete instance;
	}
	
	const cv::videostab::MoreAccurateMotionWobbleSuppressor* cv_PtrOfMoreAccurateMotionWobbleSuppressor_get_inner_ptr(const cv::Ptr<cv::videostab::MoreAccurateMotionWobbleSuppressor>* instance) {
		return instance->get();
	}

	cv::videostab::MoreAccurateMotionWobbleSuppressor* cv_PtrOfMoreAccurateMotionWobbleSuppressor_get_inner_ptr_mut(cv::Ptr<cv::videostab::MoreAccurateMotionWobbleSuppressor>* instance) {
		return instance->get();
	}
	
	cv::Ptr<cv::videostab::MoreAccurateMotionWobbleSuppressorBase>* cv_PtrOfMoreAccurateMotionWobbleSuppressor_to_PtrOfMoreAccurateMotionWobbleSuppressorBase(cv::Ptr<cv::videostab::MoreAccurateMotionWobbleSuppressor>* instance) {
	...
	cv::Ptr<cv::videostab::WobbleSuppressorBase>* cv_PtrOfMoreAccurateMotionWobbleSuppressor_to_PtrOfWobbleSuppressorBase(cv::Ptr<cv::videostab::MoreAccurateMotionWobbleSuppressor>* instance) {
...
extern "C" {
	cv::Ptr<cv::videostab::MotionEstimatorL1>* cv_PtrOfMotionEstimatorL1_new(cv::videostab::MotionEstimatorL1* val) {
			cv::Ptr<cv::videostab::MotionEstimatorL1> ret = cv::Ptr<cv::videostab::MotionEstimatorL1>(val);
			return new cv::Ptr<cv::videostab::MotionEstimatorL1>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::MotionEstimatorRansacL2>* cv_PtrOfMotionEstimatorRansacL2_new(cv::videostab::MotionEstimatorRansacL2* val) {
			cv::Ptr<cv::videostab::MotionEstimatorRansacL2> ret = cv::Ptr<cv::videostab::MotionEstimatorRansacL2>(val);
			return new cv::Ptr<cv::videostab::MotionEstimatorRansacL2>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::MotionInpainter>* cv_PtrOfMotionInpainter_new(cv::videostab::MotionInpainter* val) {
			cv::Ptr<cv::videostab::MotionInpainter> ret = cv::Ptr<cv::videostab::MotionInpainter>(val);
			return new cv::Ptr<cv::videostab::MotionInpainter>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::MotionStabilizationPipeline>* cv_PtrOfMotionStabilizationPipeline_new(cv::videostab::MotionStabilizationPipeline* val) {
			cv::Ptr<cv::videostab::MotionStabilizationPipeline> ret = cv::Ptr<cv::videostab::MotionStabilizationPipeline>(val);
			return new cv::Ptr<cv::videostab::MotionStabilizationPipeline>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::NullDeblurer>* cv_PtrOfNullDeblurer_new(cv::videostab::NullDeblurer* val) {
			cv::Ptr<cv::videostab::NullDeblurer> ret = cv::Ptr<cv::videostab::NullDeblurer>(val);
			return new cv::Ptr<cv::videostab::NullDeblurer>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::NullFrameSource>* cv_PtrOfNullFrameSource_new(cv::videostab::NullFrameSource* val) {
			cv::Ptr<cv::videostab::NullFrameSource> ret = cv::Ptr<cv::videostab::NullFrameSource>(val);
			return new cv::Ptr<cv::videostab::NullFrameSource>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::NullInpainter>* cv_PtrOfNullInpainter_new(cv::videostab::NullInpainter* val) {
			cv::Ptr<cv::videostab::NullInpainter> ret = cv::Ptr<cv::videostab::NullInpainter>(val);
			return new cv::Ptr<cv::videostab::NullInpainter>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::NullLog>* cv_PtrOfNullLog_new(cv::videostab::NullLog* val) {
			cv::Ptr<cv::videostab::NullLog> ret = cv::Ptr<cv::videostab::NullLog>(val);
			return new cv::Ptr<cv::videostab::NullLog>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::NullOutlierRejector>* cv_PtrOfNullOutlierRejector_new(cv::videostab::NullOutlierRejector* val) {
			cv::Ptr<cv::videostab::NullOutlierRejector> ret = cv::Ptr<cv::videostab::NullOutlierRejector>(val);
			return new cv::Ptr<cv::videostab::NullOutlierRejector>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::NullWobbleSuppressor>* cv_PtrOfNullWobbleSuppressor_new(cv::videostab::NullWobbleSuppressor* val) {
			cv::Ptr<cv::videostab::NullWobbleSuppressor> ret = cv::Ptr<cv::videostab::NullWobbleSuppressor>(val);
			return new cv::Ptr<cv::videostab::NullWobbleSuppressor>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::OnePassStabilizer>* cv_PtrOfOnePassStabilizer_new(cv::videostab::OnePassStabilizer* val) {
			cv::Ptr<cv::videostab::OnePassStabilizer> ret = cv::Ptr<cv::videostab::OnePassStabilizer>(val);
			return new cv::Ptr<cv::videostab::OnePassStabilizer>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::SparsePyrLkOptFlowEstimator>* cv_PtrOfSparsePyrLkOptFlowEstimator_new(cv::videostab::SparsePyrLkOptFlowEstimator* val) {
			cv::Ptr<cv::videostab::SparsePyrLkOptFlowEstimator> ret = cv::Ptr<cv::videostab::SparsePyrLkOptFlowEstimator>(val);
			return new cv::Ptr<cv::videostab::SparsePyrLkOptFlowEstimator>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::ToFileMotionWriter>* cv_PtrOfToFileMotionWriter_new(cv::videostab::ToFileMotionWriter* val) {
			cv::Ptr<cv::videostab::ToFileMotionWriter> ret = cv::Ptr<cv::videostab::ToFileMotionWriter>(val);
			return new cv::Ptr<cv::videostab::ToFileMotionWriter>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::TranslationBasedLocalOutlierRejector>* cv_PtrOfTranslationBasedLocalOutlierRejector_new(cv::videostab::TranslationBasedLocalOutlierRejector* val) {
			cv::Ptr<cv::videostab::TranslationBasedLocalOutlierRejector> ret = cv::Ptr<cv::videostab::TranslationBasedLocalOutlierRejector>(val);
			return new cv::Ptr<cv::videostab::TranslationBasedLocalOutlierRejector>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::TwoPassStabilizer>* cv_PtrOfTwoPassStabilizer_new(cv::videostab::TwoPassStabilizer* val) {
			cv::Ptr<cv::videostab::TwoPassStabilizer> ret = cv::Ptr<cv::videostab::TwoPassStabilizer>(val);
			return new cv::Ptr<cv::videostab::TwoPassStabilizer>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::VideoFileSource>* cv_PtrOfVideoFileSource_new(cv::videostab::VideoFileSource* val) {
			cv::Ptr<cv::videostab::VideoFileSource> ret = cv::Ptr<cv::videostab::VideoFileSource>(val);
			return new cv::Ptr<cv::videostab::VideoFileSource>(ret);
	}
...
extern "C" {
	cv::Ptr<cv::videostab::WeightingDeblurer>* cv_PtrOfWeightingDeblurer_new(cv::videostab::WeightingDeblurer* val) {
			cv::Ptr<cv::videostab::WeightingDeblurer> ret = cv::Ptr<cv::videostab::WeightingDeblurer>(val);
			return new cv::Ptr<cv::videostab::WeightingDeblurer>(ret);
	}
