...
extern "C" {
	void cv_superres_createFrameSource_Camera_int(int deviceId, Result<cv::Ptr<cv::superres::FrameSource>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::superres::FrameSource>*>, ocvrs_return);
	}
	...
	void cv_superres_createOptFlow_Brox_CUDA(Result<cv::Ptr<cv::superres::BroxOpticalFlow>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::superres::BroxOpticalFlow>*>, ocvrs_return);
	}
	...
	void cv_superres_createOptFlow_DualTVL1(Result<cv::Ptr<cv::superres::DualTVL1OpticalFlow>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::superres::DualTVL1OpticalFlow>*>, ocvrs_return);
	}
	...
	void cv_superres_createOptFlow_Farneback(Result<cv::Ptr<cv::superres::FarnebackOpticalFlow>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::superres::FarnebackOpticalFlow>*>, ocvrs_return);
	}
	...
	void cv_superres_createOptFlow_PyrLK_CUDA(Result<cv::Ptr<cv::superres::PyrLKOpticalFlow>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::superres::PyrLKOpticalFlow>*>, ocvrs_return);
	}
	...
	void cv_superres_createSuperResolution_BTVL1(Result<cv::Ptr<cv::superres::SuperResolution>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::superres::SuperResolution>*>, ocvrs_return);
	}
	...
	void cv_superres_SuperResolution_setInput_const_PtrLFrameSourceGR(cv::superres::SuperResolution* instance, const cv::Ptr<cv::superres::FrameSource>* frameSource, Result_void* ocvrs_return) {
		try {
	...
	void cv_superres_SuperResolution_getOpticalFlow_const(const cv::superres::SuperResolution* instance, Result<cv::Ptr<cv::superres::DenseOpticalFlowExt>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::superres::DenseOpticalFlowExt>*>, ocvrs_return);
	}
	
	void cv_superres_SuperResolution_setOpticalFlow_const_PtrLDenseOpticalFlowExtGR(cv::superres::SuperResolution* instance, const cv::Ptr<cv::superres::DenseOpticalFlowExt>* val, Result_void* ocvrs_return) {
		try {
