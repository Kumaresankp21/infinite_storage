...
extern "C" {
	...
	void cv_createAlignMTB_int_int_bool(int max_bits, int exclude_range, bool cut, Result<cv::Ptr<cv::AlignMTB>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::AlignMTB>*>, ocvrs_return);
	}
	...
	void cv_createCalibrateDebevec_int_float_bool(int samples, float lambda, bool random, Result<cv::Ptr<cv::CalibrateDebevec>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::CalibrateDebevec>*>, ocvrs_return);
	}
	...
	void cv_createCalibrateRobertson_int_float(int max_iter, float threshold, Result<cv::Ptr<cv::CalibrateRobertson>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::CalibrateRobertson>*>, ocvrs_return);
	}
	...
	void cv_createMergeDebevec(Result<cv::Ptr<cv::MergeDebevec>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::MergeDebevec>*>, ocvrs_return);
	}
	...
	void cv_createMergeMertens_float_float_float(float contrast_weight, float saturation_weight, float exposure_weight, Result<cv::Ptr<cv::MergeMertens>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::MergeMertens>*>, ocvrs_return);
	}
	...
	void cv_createMergeRobertson(Result<cv::Ptr<cv::MergeRobertson>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::MergeRobertson>*>, ocvrs_return);
	}
	...
	void cv_createTonemapDrago_float_float_float(float gamma, float saturation, float bias, Result<cv::Ptr<cv::TonemapDrago>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::TonemapDrago>*>, ocvrs_return);
	}
	...
	void cv_createTonemapMantiuk_float_float_float(float gamma, float scale, float saturation, Result<cv::Ptr<cv::TonemapMantiuk>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::TonemapMantiuk>*>, ocvrs_return);
	}
	...
	void cv_createTonemapReinhard_float_float_float_float(float gamma, float intensity, float light_adapt, float color_adapt, Result<cv::Ptr<cv::TonemapReinhard>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::TonemapReinhard>*>, ocvrs_return);
	}
	...
	void cv_createTonemap_float(float gamma, Result<cv::Ptr<cv::Tonemap>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::Tonemap>*>, ocvrs_return);
	}
	...
	void cv_denoise_TVL1_const_vectorLMatGR_MatR_double_int(const std::vector<cv::Mat>* observations, cv::Mat* result, double lambda, int niters, Result_void* ocvrs_return) {
		try {
	...
	void cv_fastNlMeansDenoisingMulti_const__InputArrayR_const__OutputArrayR_int_int_const_vectorLfloatGR_int_int_int(const cv::_InputArray* srcImgs, const cv::_OutputArray* dst, int imgToDenoiseIndex, int temporalWindowSize, const std::vector<float>* h, int templateWindowSize, int searchWindowSize, int normType, Result_void* ocvrs_return) {
		try {
	...
	void cv_fastNlMeansDenoising_const__InputArrayR_const__OutputArrayR_const_vectorLfloatGR_int_int_int(const cv::_InputArray* src, const cv::_OutputArray* dst, const std::vector<float>* h, int templateWindowSize, int searchWindowSize, int normType, Result_void* ocvrs_return) {
		try {
	...
	void cv_AlignExposures_process_const__InputArrayR_vectorLMatGR_const__InputArrayR_const__InputArrayR(cv::AlignExposures* instance, const cv::_InputArray* src, std::vector<cv::Mat>* dst, const cv::_InputArray* times, const cv::_InputArray* response, Result_void* ocvrs_return) {
		try {
	...
	void cv_AlignMTB_process_const__InputArrayR_vectorLMatGR_const__InputArrayR_const__InputArrayR(cv::AlignMTB* instance, const cv::_InputArray* src, std::vector<cv::Mat>* dst, const cv::_InputArray* times, const cv::_InputArray* response, Result_void* ocvrs_return) {
		try {
			instance->process(*src, *dst, *times, *response);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_AlignMTB_process_const__InputArrayR_vectorLMatGR(cv::AlignMTB* instance, const cv::_InputArray* src, std::vector<cv::Mat>* dst, Result_void* ocvrs_return) {
		try {
