...
extern "C" {
	...
	void cv_stereo_MatchQuasiDense_MatchQuasiDense(Result<cv::stereo::MatchQuasiDense>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::stereo::MatchQuasiDense>, ocvrs_return);
	}
	...
	void cv_stereo_QuasiDenseStereo_getSparseMatches_vectorLMatchQuasiDenseGR(cv::stereo::QuasiDenseStereo* instance, std::vector<cv::stereo::MatchQuasiDense>* sMatches, Result_void* ocvrs_return) {
		try {
	...
	void cv_stereo_QuasiDenseStereo_getDenseMatches_vectorLMatchQuasiDenseGR(cv::stereo::QuasiDenseStereo* instance, std::vector<cv::stereo::MatchQuasiDense>* denseMatches, Result_void* ocvrs_return) {
		try {
	...
	void cv_stereo_QuasiDenseStereo_create_Size_String(cv::Size* monoImgSize, char* paramFilepath, Result<cv::Ptr<cv::stereo::QuasiDenseStereo>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::stereo::QuasiDenseStereo>*>, ocvrs_return);
	}
