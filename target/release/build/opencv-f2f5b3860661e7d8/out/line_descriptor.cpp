...
extern "C" {
	void cv_line_descriptor_drawKeylines_const_MatR_const_vectorLKeyLineGR_MatR_const_ScalarR_int(const cv::Mat* image, const std::vector<cv::line_descriptor::KeyLine>* keylines, cv::Mat* outImage, const cv::Scalar* color, int flags, Result_void* ocvrs_return) {
		try {
	...
	void cv_line_descriptor_BinaryDescriptor_BinaryDescriptor_const_ParamsR(const cv::line_descriptor::BinaryDescriptor::Params* parameters, Result<cv::line_descriptor::BinaryDescriptor*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::line_descriptor::BinaryDescriptor*>, ocvrs_return);
	}
	...
	void cv_line_descriptor_BinaryDescriptor_createBinaryDescriptor(Result<cv::Ptr<cv::line_descriptor::BinaryDescriptor>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::line_descriptor::BinaryDescriptor>*>, ocvrs_return);
	}
	...
	void cv_line_descriptor_BinaryDescriptor_detect_const_MatR_vectorLKeyLineGR_const_MatR(cv::line_descriptor::BinaryDescriptor* instance, const cv::Mat* image, std::vector<cv::line_descriptor::KeyLine>* keypoints, const cv::Mat* mask, Result_void* ocvrs_return) {
		try {
	...
	void cv_line_descriptor_BinaryDescriptor_compute_const_const_MatR_vectorLKeyLineGR_MatR_bool(const cv::line_descriptor::BinaryDescriptor* instance, const cv::Mat* image, std::vector<cv::line_descriptor::KeyLine>* keylines, cv::Mat* descriptors, bool returnFloatDescr, Result_void* ocvrs_return) {
		try {
	...
	void cv_line_descriptor_BinaryDescriptor_Params_Params(Result<cv::line_descriptor::BinaryDescriptor::Params*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::line_descriptor::BinaryDescriptor::Params*>, ocvrs_return);
	}
	...
	void cv_line_descriptor_BinaryDescriptorMatcher_match_const_const_MatR_const_MatR_vectorLDMatchGR_const_MatR(const cv::line_descriptor::BinaryDescriptorMatcher* instance, const cv::Mat* queryDescriptors, const cv::Mat* trainDescriptors, std::vector<cv::DMatch>* matches, const cv::Mat* mask, Result_void* ocvrs_return) {
		try {
	...
	void cv_line_descriptor_BinaryDescriptorMatcher_match_const_MatR_vectorLDMatchGR_const_vectorLMatGR(cv::line_descriptor::BinaryDescriptorMatcher* instance, const cv::Mat* queryDescriptors, std::vector<cv::DMatch>* matches, const std::vector<cv::Mat>* masks, Result_void* ocvrs_return) {
		try {
	...
	void cv_line_descriptor_BinaryDescriptorMatcher_knnMatch_const_const_MatR_const_MatR_vectorLvectorLDMatchGGR_int_const_MatR_bool(const cv::line_descriptor::BinaryDescriptorMatcher* instance, const cv::Mat* queryDescriptors, const cv::Mat* trainDescriptors, std::vector<std::vector<cv::DMatch>>* matches, int k, const cv::Mat* mask, bool compactResult, Result_void* ocvrs_return) {
		try {
	...
	void cv_line_descriptor_BinaryDescriptorMatcher_knnMatch_const_MatR_vectorLvectorLDMatchGGR_int_const_vectorLMatGR_bool(cv::line_descriptor::BinaryDescriptorMatcher* instance, const cv::Mat* queryDescriptors, std::vector<std::vector<cv::DMatch>>* matches, int k, const std::vector<cv::Mat>* masks, bool compactResult, Result_void* ocvrs_return) {
		try {
	...
	void cv_line_descriptor_BinaryDescriptorMatcher_add_const_vectorLMatGR(cv::line_descriptor::BinaryDescriptorMatcher* instance, const std::vector<cv::Mat>* descriptors, Result_void* ocvrs_return) {
		try {
	...
	void cv_line_descriptor_BinaryDescriptorMatcher_createBinaryDescriptorMatcher(Result<cv::Ptr<cv::line_descriptor::BinaryDescriptorMatcher>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::line_descriptor::BinaryDescriptorMatcher>*>, ocvrs_return);
	}
	...
	void cv_line_descriptor_BinaryDescriptorMatcher_BinaryDescriptorMatcher(Result<cv::line_descriptor::BinaryDescriptorMatcher*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::line_descriptor::BinaryDescriptorMatcher*>, ocvrs_return);
	}
	...
	void cv_line_descriptor_KeyLine_KeyLine(Result<cv::line_descriptor::KeyLine>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::line_descriptor::KeyLine>, ocvrs_return);
	}
	...
	void cv_line_descriptor_LSDDetector_LSDDetector(Result<cv::line_descriptor::LSDDetector*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::line_descriptor::LSDDetector*>, ocvrs_return);
	}
	...
	void cv_line_descriptor_LSDDetector_createLSDDetector(Result<cv::Ptr<cv::line_descriptor::LSDDetector>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::line_descriptor::LSDDetector>*>, ocvrs_return);
	}
	...
	void cv_line_descriptor_LSDDetector_detect_const_MatR_vectorLKeyLineGR_int_int_const_MatR(cv::line_descriptor::LSDDetector* instance, const cv::Mat* image, std::vector<cv::line_descriptor::KeyLine>* keypoints, int scale, int numOctaves, const cv::Mat* mask, Result_void* ocvrs_return) {
		try {
	...
	void cv_line_descriptor_LSDParam_LSDParam(Result<cv::line_descriptor::LSDParam>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::line_descriptor::LSDParam>, ocvrs_return);
	}
