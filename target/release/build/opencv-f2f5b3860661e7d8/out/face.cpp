...
extern "C" {
	void cv_face_createFacemarkAAM(Result<cv::Ptr<cv::face::Facemark>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::face::Facemark>*>, ocvrs_return);
	}
	...
	void cv_face_loadDatasetList_String_String_vectorLStringGR_vectorLStringGR(char* imageList, char* annotationList, std::vector<cv::String>* images, std::vector<cv::String>* annotations, Result<bool>* ocvrs_return) {
		try {
	...
	void cv_face_loadTrainingData_String_String_vectorLStringGR_const__OutputArrayR_float(char* imageList, char* groundTruth, std::vector<cv::String>* images, const cv::_OutputArray* facePoints, float offset, Result<bool>* ocvrs_return) {
		try {
	...
	void cv_face_loadTrainingData_String_vectorLStringGR_const__OutputArrayR_char_float(char* filename, std::vector<cv::String>* images, const cv::_OutputArray* facePoints, char delim, float offset, Result<bool>* ocvrs_return) {
		try {
	...
	void cv_face_BIF_create_int_int(int num_bands, int num_rotations, Result<cv::Ptr<cv::face::BIF>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::face::BIF>*>, ocvrs_return);
	}
	...
	void cv_face_CParams_CParams_String_double_int_Size_Size(char* cascade_model, double sf, int minN, cv::Size* minSz, cv::Size* maxSz, Result<cv::face::CParams*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::face::CParams*>, ocvrs_return);
	}
	...
	void cv_face_EigenFaceRecognizer_create_int_double(int num_components, double threshold, Result<cv::Ptr<cv::face::EigenFaceRecognizer>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::face::EigenFaceRecognizer>*>, ocvrs_return);
	}
	...
	void cv_face_FaceRecognizer_predict_const_const__InputArrayR_PtrLPredictCollectorG(const cv::face::FaceRecognizer* instance, const cv::_InputArray* src, cv::Ptr<cv::face::PredictCollector>* collector, Result_void* ocvrs_return) {
		try {
	...
	void cv_face_FacemarkAAM_create_const_ParamsR(const cv::face::FacemarkAAM::Params* parameters, Result<cv::Ptr<cv::face::FacemarkAAM>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::face::FacemarkAAM>*>, ocvrs_return);
	}
	...
	void cv_face_FacemarkAAM_Config_Config_Mat_Point2f_float_int(cv::Mat* rot, cv::Point2f* trans, float scaling, int scale_id, Result<cv::face::FacemarkAAM::Config*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::face::FacemarkAAM::Config*>, ocvrs_return);
	}
	...
	void cv_face_FacemarkAAM_Data_setPropS0_vectorLPoint2fG(cv::face::FacemarkAAM::Data* instance, std::vector<cv::Point2f>* val) {
			instance->s0 = *val;
	}
	...
	void cv_face_FacemarkAAM_Model_setPropScales_vectorLfloatG(cv::face::FacemarkAAM::Model* instance, std::vector<float>* val) {
			instance->scales = *val;
	}
	...
	void cv_face_FacemarkAAM_Model_setPropTriangles_vectorLVec3iG(cv::face::FacemarkAAM::Model* instance, std::vector<cv::Vec3i>* val) {
	...
	void cv_face_FacemarkAAM_Model_setPropTextures_vectorLTextureG(cv::face::FacemarkAAM::Model* instance, std::vector<cv::face::FacemarkAAM::Model::Texture>* val) {
	...
	void cv_face_FacemarkAAM_Model_setPropS0_vectorLPoint2fG(cv::face::FacemarkAAM::Model* instance, std::vector<cv::Point2f>* val) {
			instance->s0 = *val;
	}
	...
	void cv_face_FacemarkAAM_Model_Texture_setPropTextureIdx_vectorLvectorLPointGG(cv::face::FacemarkAAM::Model::Texture* instance, std::vector<std::vector<cv::Point>>* val) {
	...
	void cv_face_FacemarkAAM_Model_Texture_setPropBase_shape_vectorLPoint2fG(cv::face::FacemarkAAM::Model::Texture* instance, std::vector<cv::Point2f>* val) {
	...
	void cv_face_FacemarkAAM_Model_Texture_setPropInd1_vectorLintG(cv::face::FacemarkAAM::Model::Texture* instance, std::vector<int>* val) {
			instance->ind1 = *val;
	}
	...
	void cv_face_FacemarkAAM_Model_Texture_setPropInd2_vectorLintG(cv::face::FacemarkAAM::Model::Texture* instance, std::vector<int>* val) {
			instance->ind2 = *val;
	}
	...
	void cv_face_FacemarkAAM_Params_setPropScales_vectorLfloatG(cv::face::FacemarkAAM::Params* instance, std::vector<float>* val) {
			instance->scales = *val;
	}
	...
	void cv_face_FacemarkAAM_Params_Params(Result<cv::face::FacemarkAAM::Params*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::face::FacemarkAAM::Params*>, ocvrs_return);
	}
	...
	void cv_face_FacemarkKazemi_create_const_ParamsR(const cv::face::FacemarkKazemi::Params* parameters, Result<cv::Ptr<cv::face::FacemarkKazemi>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::face::FacemarkKazemi>*>, ocvrs_return);
	}
	
	void cv_face_FacemarkKazemi_training_vectorLMatGR_vectorLvectorLPoint2fGGR_string_Size_string(cv::face::FacemarkKazemi* instance, std::vector<cv::Mat>* images, std::vector<std::vector<cv::Point2f>>* landmarks, char* configfile, cv::Size* scale, char* modelFilename, Result<bool>* ocvrs_return) {
		try {
	...
	void cv_face_FacemarkKazemi_Params_Params(Result<cv::face::FacemarkKazemi::Params*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::face::FacemarkKazemi::Params*>, ocvrs_return);
	}
	...
	void cv_face_FacemarkLBF_create_const_ParamsR(const cv::face::FacemarkLBF::Params* parameters, Result<cv::Ptr<cv::face::FacemarkLBF>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::face::FacemarkLBF>*>, ocvrs_return);
	}
	...
	void cv_face_FacemarkLBF_Params_setPropFeats_m_vectorLintG(cv::face::FacemarkLBF::Params* instance, std::vector<int>* val) {
	...
	void cv_face_FacemarkLBF_Params_setPropRadius_m_vectorLdoubleG(cv::face::FacemarkLBF::Params* instance, std::vector<double>* val) {
	...
	void cv_face_FacemarkLBF_Params_Params(Result<cv::face::FacemarkLBF::Params*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::face::FacemarkLBF::Params*>, ocvrs_return);
	}
	...
	void cv_face_FisherFaceRecognizer_create_int_double(int num_components, double threshold, Result<cv::Ptr<cv::face::FisherFaceRecognizer>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::face::FisherFaceRecognizer>*>, ocvrs_return);
	}
	...
	void cv_face_LBPHFaceRecognizer_create_int_int_int_int_double(int radius, int neighbors, int grid_x, int grid_y, double threshold, Result<cv::Ptr<cv::face::LBPHFaceRecognizer>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::face::LBPHFaceRecognizer>*>, ocvrs_return);
	}
	...
	void cv_face_MACE_load_const_StringR_const_StringR(const char* filename, const char* objname, Result<cv::Ptr<cv::face::MACE>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::face::MACE>*>, ocvrs_return);
	}
	...
	void cv_face_StandardCollector_StandardCollector_double(double threshold_, Result<cv::face::StandardCollector*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::face::StandardCollector*>, ocvrs_return);
	}
	...
	void cv_face_StandardCollector_getResults_const_bool(const cv::face::StandardCollector* instance, bool sorted, Result<std::vector<std::pair<int, double>>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(OCVRS_TYPE(Result<std::vector<std::pair<int, double>>*>), ocvrs_return);
	}
	...
	void cv_face_StandardCollector_create_double(double threshold, Result<cv::Ptr<cv::face::StandardCollector>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::face::StandardCollector>*>, ocvrs_return);
	}
	...
	void cv_face_StandardCollector_PredictResult_PredictResult_int_double(int label_, double distance_, Result<cv::face::StandardCollector::PredictResult>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::face::StandardCollector::PredictResult>, ocvrs_return);
	}
