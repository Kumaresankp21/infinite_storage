...
extern "C" {
	...
	void cv_xobjdetect_WBDetector_detect_const_MatR_vectorLRectGR_vectorLdoubleGR(cv::xobjdetect::WBDetector* instance, const cv::Mat* img, std::vector<cv::Rect>* bboxes, std::vector<double>* confidences, Result_void* ocvrs_return) {
		try {
	...
	void cv_xobjdetect_WBDetector_create(Result<cv::Ptr<cv::xobjdetect::WBDetector>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::xobjdetect::WBDetector>*>, ocvrs_return);
	}
