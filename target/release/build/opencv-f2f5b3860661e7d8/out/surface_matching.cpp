...
extern "C" {
	...
	void cv_ppf_match_3d_ICP_ICP(Result<cv::ppf_match_3d::ICP*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::ppf_match_3d::ICP*>, ocvrs_return);
	}
	...
	void cv_ppf_match_3d_PPF3DDetector_PPF3DDetector(Result<cv::ppf_match_3d::PPF3DDetector*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::ppf_match_3d::PPF3DDetector*>, ocvrs_return);
	}
	...
	void cv_ppf_match_3d_PPF3DDetector_match_const_MatR_vectorLPose3DPtrGR_const_double_const_double(cv::ppf_match_3d::PPF3DDetector* instance, const cv::Mat* scene, std::vector<cv::ppf_match_3d::Pose3DPtr>* results, const double relativeSceneSampleStep, const double relativeSceneDistance, Result_void* ocvrs_return) {
		try {
	...
	void cv_ppf_match_3d_Pose3D_Pose3D(Result<cv::ppf_match_3d::Pose3D*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::ppf_match_3d::Pose3D*>, ocvrs_return);
	}
	...
	void cv_ppf_match_3d_Pose3D_clone(cv::ppf_match_3d::Pose3D* instance, Result<cv::ppf_match_3d::Pose3DPtr*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::ppf_match_3d::Pose3DPtr*>, ocvrs_return);
	}
	...
	void cv_ppf_match_3d_PoseCluster3D_setPropPoseList_vectorLPose3DPtrG(cv::ppf_match_3d::PoseCluster3D* instance, std::vector<cv::ppf_match_3d::Pose3DPtr>* val) {
	...
	void cv_ppf_match_3d_PoseCluster3D_PoseCluster3D(Result<cv::ppf_match_3d::PoseCluster3D*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::ppf_match_3d::PoseCluster3D*>, ocvrs_return);
	}
