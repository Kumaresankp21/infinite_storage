...
extern "C" {
	void cv_detail_autoDetectWaveCorrectKind_const_vectorLMatGR(const std::vector<cv::Mat>* rmats, Result<cv::detail::WaveCorrectKind>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::WaveCorrectKind>, ocvrs_return);
	}
	
	void cv_detail_computeImageFeatures_const_PtrLFeature2DGR_const__InputArrayR_ImageFeaturesR_const__InputArrayR(const cv::Ptr<cv::Feature2D>* featuresFinder, const cv::_InputArray* image, cv::detail::ImageFeatures* features, const cv::_InputArray* mask, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_computeImageFeatures_const_PtrLFeature2DGR_const__InputArrayR_vectorLImageFeaturesGR_const__InputArrayR(const cv::Ptr<cv::Feature2D>* featuresFinder, const cv::_InputArray* images, std::vector<cv::detail::ImageFeatures>* features, const cv::_InputArray* masks, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_createLaplacePyrGpu_const__InputArrayR_int_vectorLUMatGR(const cv::_InputArray* img, int num_levels, std::vector<cv::UMat>* pyr, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_createLaplacePyr_const__InputArrayR_int_vectorLUMatGR(const cv::_InputArray* img, int num_levels, std::vector<cv::UMat>* pyr, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_findMaxSpanningTree_int_const_vectorLMatchesInfoGR_GraphR_vectorLintGR(int num_images, const std::vector<cv::detail::MatchesInfo>* pairwise_matches, cv::detail::Graph* span_tree, std::vector<int>* centers, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_restoreImageFromLaplacePyrGpu_vectorLUMatGR(std::vector<cv::UMat>* pyr, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_restoreImageFromLaplacePyr_vectorLUMatGR(std::vector<cv::UMat>* pyr, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_selectRandomSubset_int_int_vectorLintGR(int count, int size, std::vector<int>* subset, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_waveCorrect_vectorLMatGR_WaveCorrectKind(std::vector<cv::Mat>* rmats, cv::detail::WaveCorrectKind kind, Result_void* ocvrs_return) {
		try {
	...
	void cv_AffineWarper_create_const_float(const cv::AffineWarper* instance, float scale, Result<cv::Ptr<cv::detail::RotationWarper>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::detail::RotationWarper>*>, ocvrs_return);
	}
	...
	void cv_CompressedRectilinearPortraitWarper_CompressedRectilinearPortraitWarper_float_float(float A, float B, Result<cv::CompressedRectilinearPortraitWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::CompressedRectilinearPortraitWarper*>, ocvrs_return);
	}
	...
	void cv_CompressedRectilinearWarper_CompressedRectilinearWarper_float_float(float A, float B, Result<cv::CompressedRectilinearWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::CompressedRectilinearWarper*>, ocvrs_return);
	}
	...
	void cv_PaniniPortraitWarper_PaniniPortraitWarper_float_float(float A, float B, Result<cv::PaniniPortraitWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::PaniniPortraitWarper*>, ocvrs_return);
	}
	...
	void cv_PaniniWarper_PaniniWarper_float_float(float A, float B, Result<cv::PaniniWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::PaniniWarper*>, ocvrs_return);
	}
	...
	void cv_PyRotationWarper_PyRotationWarper_String_float(char* type, float scale, Result<cv::PyRotationWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::PyRotationWarper*>, ocvrs_return);
	}
	...
	void cv_Stitcher_create_Mode(cv::Stitcher::Mode mode, Result<cv::Ptr<cv::Stitcher>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::Stitcher>*>, ocvrs_return);
	}
	...
	void cv_Stitcher_interpolationFlags_const(const cv::Stitcher* instance, Result<cv::InterpolationFlags>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::InterpolationFlags>, ocvrs_return);
	}
	...
	void cv_Stitcher_featuresFinder(cv::Stitcher* instance, Result<cv::Ptr<cv::Feature2D>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::Feature2D>*>, ocvrs_return);
	}
	...
	void cv_Stitcher_setFeaturesFinder_PtrLFeature2DG(cv::Stitcher* instance, cv::Ptr<cv::Feature2D>* features_finder, Result_void* ocvrs_return) {
		try {
	...
	void cv_Stitcher_featuresMatcher(cv::Stitcher* instance, Result<cv::Ptr<cv::detail::FeaturesMatcher>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::detail::FeaturesMatcher>*>, ocvrs_return);
	}
	...
	void cv_Stitcher_setFeaturesMatcher_PtrLFeaturesMatcherG(cv::Stitcher* instance, cv::Ptr<cv::detail::FeaturesMatcher>* features_matcher, Result_void* ocvrs_return) {
		try {
	...
	void cv_Stitcher_matchingMask_const(const cv::Stitcher* instance, Result<cv::UMat*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::UMat*>, ocvrs_return);
	}
	...
	void cv_Stitcher_bundleAdjuster(cv::Stitcher* instance, Result<cv::Ptr<cv::detail::BundleAdjusterBase>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::detail::BundleAdjusterBase>*>, ocvrs_return);
	}
	...
	void cv_Stitcher_setBundleAdjuster_PtrLBundleAdjusterBaseG(cv::Stitcher* instance, cv::Ptr<cv::detail::BundleAdjusterBase>* bundle_adjuster, Result_void* ocvrs_return) {
		try {
	...
	void cv_Stitcher_estimator(cv::Stitcher* instance, Result<cv::Ptr<cv::detail::Estimator>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::detail::Estimator>*>, ocvrs_return);
	}
	...
	void cv_Stitcher_setEstimator_PtrLEstimatorG(cv::Stitcher* instance, cv::Ptr<cv::detail::Estimator>* estimator, Result_void* ocvrs_return) {
		try {
	...
	void cv_Stitcher_warper(cv::Stitcher* instance, Result<cv::Ptr<cv::WarperCreator>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::WarperCreator>*>, ocvrs_return);
	}
	...
	void cv_Stitcher_setWarper_PtrLWarperCreatorG(cv::Stitcher* instance, cv::Ptr<cv::WarperCreator>* creator, Result_void* ocvrs_return) {
		try {
	...
	void cv_Stitcher_exposureCompensator(cv::Stitcher* instance, Result<cv::Ptr<cv::detail::ExposureCompensator>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::detail::ExposureCompensator>*>, ocvrs_return);
	}
	...
	void cv_Stitcher_setExposureCompensator_PtrLExposureCompensatorG(cv::Stitcher* instance, cv::Ptr<cv::detail::ExposureCompensator>* exposure_comp, Result_void* ocvrs_return) {
		try {
	...
	void cv_Stitcher_seamFinder(cv::Stitcher* instance, Result<cv::Ptr<cv::detail::SeamFinder>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::detail::SeamFinder>*>, ocvrs_return);
	}
	...
	void cv_Stitcher_setSeamFinder_PtrLSeamFinderG(cv::Stitcher* instance, cv::Ptr<cv::detail::SeamFinder>* seam_finder, Result_void* ocvrs_return) {
		try {
	...
	void cv_Stitcher_blender(cv::Stitcher* instance, Result<cv::Ptr<cv::detail::Blender>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::detail::Blender>*>, ocvrs_return);
	}
	...
	void cv_Stitcher_setBlender_PtrLBlenderG(cv::Stitcher* instance, cv::Ptr<cv::detail::Blender>* b, Result_void* ocvrs_return) {
		try {
	...
	void cv_Stitcher_estimateTransform_const__InputArrayR_const__InputArrayR(cv::Stitcher* instance, const cv::_InputArray* images, const cv::_InputArray* masks, Result<cv::Stitcher::Status>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::Stitcher::Status>, ocvrs_return);
	}
	...
	void cv_Stitcher_cameras_const(const cv::Stitcher* instance, Result<std::vector<cv::detail::CameraParams>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<std::vector<cv::detail::CameraParams>*>, ocvrs_return);
	}
	...
	void cv_detail_AffineBasedEstimator_AffineBasedEstimator(Result<cv::detail::AffineBasedEstimator*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::AffineBasedEstimator*>, ocvrs_return);
	}
	...
	void cv_detail_AffineBestOf2NearestMatcher_AffineBestOf2NearestMatcher_bool_bool_float_int(bool full_affine, bool try_use_gpu, float match_conf, int num_matches_thresh1, Result<cv::detail::AffineBestOf2NearestMatcher*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::AffineBestOf2NearestMatcher*>, ocvrs_return);
	}
	...
	void cv_detail_AffineWarper_AffineWarper_float(float scale, Result<cv::detail::AffineWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::AffineWarper*>, ocvrs_return);
	}
	...
	void cv_detail_BestOf2NearestMatcher_BestOf2NearestMatcher_bool_float_int_int(bool try_use_gpu, float match_conf, int num_matches_thresh1, int num_matches_thresh2, Result<cv::detail::BestOf2NearestMatcher*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::BestOf2NearestMatcher*>, ocvrs_return);
	}
	...
	void cv_detail_BestOf2NearestMatcher_create_bool_float_int_int(bool try_use_gpu, float match_conf, int num_matches_thresh1, int num_matches_thresh2, Result<cv::Ptr<cv::detail::BestOf2NearestMatcher>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<cv::Ptr<cv::detail::BestOf2NearestMatcher>*>, ocvrs_return);
	}
	...
	void cv_detail_BestOf2NearestRangeMatcher_BestOf2NearestRangeMatcher_int_bool_float_int_int(int range_width, bool try_use_gpu, float match_conf, int num_matches_thresh1, int num_matches_thresh2, Result<cv::detail::BestOf2NearestRangeMatcher*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::BestOf2NearestRangeMatcher*>, ocvrs_return);
	}
	
	void cv_detail_BestOf2NearestRangeMatcher_operator___const_vectorLImageFeaturesGR_vectorLMatchesInfoGR_const_UMatR(cv::detail::BestOf2NearestRangeMatcher* instance, const std::vector<cv::detail::ImageFeatures>* features, std::vector<cv::detail::MatchesInfo>* pairwise_matches, const cv::UMat* mask, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_Blender_prepare_const_vectorLPointGR_const_vectorLSizeGR(cv::detail::Blender* instance, const std::vector<cv::Point>* corners, const std::vector<cv::Size>* sizes, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_BlocksChannelsCompensator_BlocksChannelsCompensator_int_int_int(int bl_width, int bl_height, int nr_feeds, Result<cv::detail::BlocksChannelsCompensator*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::BlocksChannelsCompensator*>, ocvrs_return);
	}
	
	void cv_detail_BlocksChannelsCompensator_feed_const_vectorLPointGR_const_vectorLUMatGR_const_vectorLpairLcv_UMat__unsigned_charGGR(cv::detail::BlocksChannelsCompensator* instance, const std::vector<cv::Point>* corners, const std::vector<cv::UMat>* images, const std::vector<std::pair<cv::UMat, unsigned char>>* masks, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_BlocksCompensator_getMatGains_vectorLMatGR(cv::detail::BlocksCompensator* instance, std::vector<cv::Mat>* umv, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_BlocksCompensator_setMatGains_vectorLMatGR(cv::detail::BlocksCompensator* instance, std::vector<cv::Mat>* umv, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_BlocksGainCompensator_BlocksGainCompensator_int_int(int bl_width, int bl_height, Result<cv::detail::BlocksGainCompensator*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::BlocksGainCompensator*>, ocvrs_return);
	}
	...
	void cv_detail_BlocksGainCompensator_getMatGains_vectorLMatGR(cv::detail::BlocksGainCompensator* instance, std::vector<cv::Mat>* umv, Result_void* ocvrs_return) {
		try {
			instance->getMatGains(*umv);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_BlocksGainCompensator_setMatGains_vectorLMatGR(cv::detail::BlocksGainCompensator* instance, std::vector<cv::Mat>* umv, Result_void* ocvrs_return) {
		try {
			instance->setMatGains(*umv);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_BundleAdjusterAffine_BundleAdjusterAffine(Result<cv::detail::BundleAdjusterAffine*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::BundleAdjusterAffine*>, ocvrs_return);
	}
	...
	void cv_detail_BundleAdjusterAffinePartial_BundleAdjusterAffinePartial(Result<cv::detail::BundleAdjusterAffinePartial*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::BundleAdjusterAffinePartial*>, ocvrs_return);
	}
	...
	void cv_detail_BundleAdjusterBase_termCriteria(cv::detail::BundleAdjusterBase* instance, Result<cv::TermCriteria>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::TermCriteria>, ocvrs_return);
	}
	...
	void cv_detail_BundleAdjusterRay_BundleAdjusterRay(Result<cv::detail::BundleAdjusterRay*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::BundleAdjusterRay*>, ocvrs_return);
	}
	...
	void cv_detail_BundleAdjusterReproj_BundleAdjusterReproj(Result<cv::detail::BundleAdjusterReproj*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::BundleAdjusterReproj*>, ocvrs_return);
	}
	...
	void cv_detail_CameraParams_CameraParams(Result<cv::detail::CameraParams*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::CameraParams*>, ocvrs_return);
	}
	...
	void cv_detail_ChannelsCompensator_ChannelsCompensator_int(int nr_feeds, Result<cv::detail::ChannelsCompensator*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::ChannelsCompensator*>, ocvrs_return);
	}
	
	void cv_detail_ChannelsCompensator_feed_const_vectorLPointGR_const_vectorLUMatGR_const_vectorLpairLcv_UMat__unsigned_charGGR(cv::detail::ChannelsCompensator* instance, const std::vector<cv::Point>* corners, const std::vector<cv::UMat>* images, const std::vector<std::pair<cv::UMat, unsigned char>>* masks, Result_void* ocvrs_return) {
		try {
			instance->feed(*corners, *images, *masks);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_ChannelsCompensator_getMatGains_vectorLMatGR(cv::detail::ChannelsCompensator* instance, std::vector<cv::Mat>* umv, Result_void* ocvrs_return) {
		try {
			instance->getMatGains(*umv);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_ChannelsCompensator_setMatGains_vectorLMatGR(cv::detail::ChannelsCompensator* instance, std::vector<cv::Mat>* umv, Result_void* ocvrs_return) {
		try {
			instance->setMatGains(*umv);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_ChannelsCompensator_gains_const(const cv::detail::ChannelsCompensator* instance, Result<std::vector<cv::Scalar>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<std::vector<cv::Scalar>*>, ocvrs_return);
	}
	...
	void cv_detail_CompressedRectilinearPortraitWarper_CompressedRectilinearPortraitWarper_float_float_float(float scale, float A, float B, Result<cv::detail::CompressedRectilinearPortraitWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::CompressedRectilinearPortraitWarper*>, ocvrs_return);
	}
	...
	void cv_detail_CompressedRectilinearWarper_CompressedRectilinearWarper_float_float_float(float scale, float A, float B, Result<cv::detail::CompressedRectilinearWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::CompressedRectilinearWarper*>, ocvrs_return);
	}
	...
	void cv_detail_CylindricalPortraitWarper_CylindricalPortraitWarper_float(float scale, Result<cv::detail::CylindricalPortraitWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::CylindricalPortraitWarper*>, ocvrs_return);
	}
	...
	void cv_detail_CylindricalWarper_CylindricalWarper_float(float scale, Result<cv::detail::CylindricalWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::CylindricalWarper*>, ocvrs_return);
	}
	...
	void cv_detail_CylindricalWarperGpu_CylindricalWarperGpu_float(float scale, Result<cv::detail::CylindricalWarperGpu*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::CylindricalWarperGpu*>, ocvrs_return);
	}
	...
	void cv_detail_DisjointSets_setPropParent_vectorLintG(cv::detail::DisjointSets* instance, std::vector<int>* val) {
			instance->parent = *val;
	}
	...
	void cv_detail_DisjointSets_setPropSize_vectorLintG(cv::detail::DisjointSets* instance, std::vector<int>* val) {
			instance->size = *val;
	}
	...
	void cv_detail_DisjointSets_DisjointSets_int(int elem_count, Result<cv::detail::DisjointSets*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::DisjointSets*>, ocvrs_return);
	}
	...
	void cv_detail_DpSeamFinder_DpSeamFinder_CostFunction(cv::detail::DpSeamFinder::CostFunction costFunc, Result<cv::detail::DpSeamFinder*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::DpSeamFinder*>, ocvrs_return);
	}
	...
	void cv_detail_DpSeamFinder_costFunction_const(const cv::detail::DpSeamFinder* instance, Result<cv::detail::DpSeamFinder::CostFunction>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::DpSeamFinder::CostFunction>, ocvrs_return);
	}
	...
	void cv_detail_DpSeamFinder_find_const_vectorLUMatGR_const_vectorLPointGR_vectorLUMatGR(cv::detail::DpSeamFinder* instance, const std::vector<cv::UMat>* src, const std::vector<cv::Point>* corners, std::vector<cv::UMat>* masks, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_ExposureCompensator_feed_const_vectorLPointGR_const_vectorLUMatGR_const_vectorLUMatGR(cv::detail::ExposureCompensator* instance, const std::vector<cv::Point>* corners, const std::vector<cv::UMat>* images, const std::vector<cv::UMat>* masks, Result_void* ocvrs_return) {
		try {
			instance->feed(*corners, *images, *masks);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_ExposureCompensator_feed_const_vectorLPointGR_const_vectorLUMatGR_const_vectorLpairLcv_UMat__unsigned_charGGR(cv::detail::ExposureCompensator* instance, const std::vector<cv::Point>* corners, const std::vector<cv::UMat>* images, const std::vector<std::pair<cv::UMat, unsigned char>>* masks, Result_void* ocvrs_return) {
		try {
			instance->feed(*corners, *images, *masks);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_ExposureCompensator_getMatGains_vectorLMatGR(cv::detail::ExposureCompensator* instance, std::vector<cv::Mat>* unnamed, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_ExposureCompensator_setMatGains_vectorLMatGR(cv::detail::ExposureCompensator* instance, std::vector<cv::Mat>* unnamed, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_FeatherBlender_FeatherBlender_float(float sharpness, Result<cv::detail::FeatherBlender*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::FeatherBlender*>, ocvrs_return);
	}
	...
	void cv_detail_FeaturesMatcher_operator___const_ImageFeaturesR_const_ImageFeaturesR_MatchesInfoR(cv::detail::FeaturesMatcher* instance, const cv::detail::ImageFeatures* features1, const cv::detail::ImageFeatures* features2, cv::detail::MatchesInfo* matches_info, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_FeaturesMatcher_operator___const_vectorLImageFeaturesGR_vectorLMatchesInfoGR_const_UMatR(cv::detail::FeaturesMatcher* instance, const std::vector<cv::detail::ImageFeatures>* features, std::vector<cv::detail::MatchesInfo>* pairwise_matches, const cv::UMat* mask, Result_void* ocvrs_return) {
		try {
			instance->operator()(*features, *pairwise_matches, *mask);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_FisheyeWarper_FisheyeWarper_float(float scale, Result<cv::detail::FisheyeWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::FisheyeWarper*>, ocvrs_return);
	}
	...
	void cv_detail_GainCompensator_GainCompensator(Result<cv::detail::GainCompensator*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::GainCompensator*>, ocvrs_return);
	}
	...
	void cv_detail_GainCompensator_feed_const_vectorLPointGR_const_vectorLUMatGR_const_vectorLpairLcv_UMat__unsigned_charGGR(cv::detail::GainCompensator* instance, const std::vector<cv::Point>* corners, const std::vector<cv::UMat>* images, const std::vector<std::pair<cv::UMat, unsigned char>>* masks, Result_void* ocvrs_return) {
		try {
			instance->feed(*corners, *images, *masks);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_GainCompensator_singleFeed_const_vectorLPointGR_const_vectorLUMatGR_const_vectorLpairLcv_UMat__unsigned_charGGR(cv::detail::GainCompensator* instance, const std::vector<cv::Point>* corners, const std::vector<cv::UMat>* images, const std::vector<std::pair<cv::UMat, unsigned char>>* masks, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_GainCompensator_getMatGains_vectorLMatGR(cv::detail::GainCompensator* instance, std::vector<cv::Mat>* umv, Result_void* ocvrs_return) {
		try {
			instance->getMatGains(*umv);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_GainCompensator_setMatGains_vectorLMatGR(cv::detail::GainCompensator* instance, std::vector<cv::Mat>* umv, Result_void* ocvrs_return) {
		try {
			instance->setMatGains(*umv);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_GainCompensator_prepareSimilarityMask_const_vectorLPointGR_const_vectorLUMatGR(cv::detail::GainCompensator* instance, const std::vector<cv::Point>* corners, const std::vector<cv::UMat>* images, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_GainCompensator_gains_const(const cv::detail::GainCompensator* instance, Result<std::vector<double>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<std::vector<double>*>, ocvrs_return);
	}
	...
	void cv_detail_Graph_Graph_int(int num_vertices, Result<cv::detail::Graph*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::Graph*>, ocvrs_return);
	}
	...
	void cv_detail_GraphCutSeamFinder_GraphCutSeamFinder_int_float_float(int cost_type, float terminal_cost, float bad_region_penalty, Result<cv::detail::GraphCutSeamFinder*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::GraphCutSeamFinder*>, ocvrs_return);
	}
	...
	void cv_detail_GraphCutSeamFinder_find_const_vectorLUMatGR_const_vectorLPointGR_vectorLUMatGR(cv::detail::GraphCutSeamFinder* instance, const std::vector<cv::UMat>* src, const std::vector<cv::Point>* corners, std::vector<cv::UMat>* masks, Result_void* ocvrs_return) {
		try {
			instance->find(*src, *corners, *masks);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_GraphEdge_GraphEdge_int_int_float(int from, int to, float weight, Result<cv::detail::GraphEdge*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::GraphEdge*>, ocvrs_return);
	}
	...
	void cv_detail_HomographyBasedEstimator_HomographyBasedEstimator_bool(bool is_focals_estimated, Result<cv::detail::HomographyBasedEstimator*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::HomographyBasedEstimator*>, ocvrs_return);
	}
	...
	void cv_detail_ImageFeatures_setPropKeypoints_vectorLKeyPointG(cv::detail::ImageFeatures* instance, std::vector<cv::KeyPoint>* val) {
	...
	void cv_detail_ImageFeatures_getKeypoints(cv::detail::ImageFeatures* instance, Result<std::vector<cv::KeyPoint>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<std::vector<cv::KeyPoint>*>, ocvrs_return);
	}
	...
	void cv_detail_MatchesInfo_setPropMatches_vectorLDMatchG(cv::detail::MatchesInfo* instance, std::vector<cv::DMatch>* val) {
	...
	void cv_detail_MatchesInfo_setPropInliers_mask_vectorLunsigned_charG(cv::detail::MatchesInfo* instance, std::vector<unsigned char>* val) {
	...
	void cv_detail_MatchesInfo_MatchesInfo(Result<cv::detail::MatchesInfo*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::MatchesInfo*>, ocvrs_return);
	}
	...
	void cv_detail_MatchesInfo_getMatches(cv::detail::MatchesInfo* instance, Result<std::vector<cv::DMatch>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<std::vector<cv::DMatch>*>, ocvrs_return);
	}
	...
	void cv_detail_MatchesInfo_getInliers(cv::detail::MatchesInfo* instance, Result<std::vector<unsigned char>*>* ocvrs_return) {
		...
		} OCVRS_CATCH(Result<std::vector<unsigned char>*>, ocvrs_return);
	}
	...
	void cv_detail_MercatorWarper_MercatorWarper_float(float scale, Result<cv::detail::MercatorWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::MercatorWarper*>, ocvrs_return);
	}
	...
	void cv_detail_MultiBandBlender_MultiBandBlender_int_int_int(int try_gpu, int num_bands, int weight_type, Result<cv::detail::MultiBandBlender*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::MultiBandBlender*>, ocvrs_return);
	}
	...
	void cv_detail_NoBundleAdjuster_NoBundleAdjuster(Result<cv::detail::NoBundleAdjuster*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::NoBundleAdjuster*>, ocvrs_return);
	}
	...
	void cv_detail_NoExposureCompensator_feed_const_vectorLPointGR_const_vectorLUMatGR_const_vectorLpairLcv_UMat__unsigned_charGGR(cv::detail::NoExposureCompensator* instance, const std::vector<cv::Point>* unnamed, const std::vector<cv::UMat>* unnamed_1, const std::vector<std::pair<cv::UMat, unsigned char>>* unnamed_2, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_NoExposureCompensator_getMatGains_vectorLMatGR(cv::detail::NoExposureCompensator* instance, std::vector<cv::Mat>* umv, Result_void* ocvrs_return) {
		try {
			instance->getMatGains(*umv);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_NoExposureCompensator_setMatGains_vectorLMatGR(cv::detail::NoExposureCompensator* instance, std::vector<cv::Mat>* umv, Result_void* ocvrs_return) {
		try {
			instance->setMatGains(*umv);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_NoSeamFinder_find_const_vectorLUMatGR_const_vectorLPointGR_vectorLUMatGR(cv::detail::NoSeamFinder* instance, const std::vector<cv::UMat>* unnamed, const std::vector<cv::Point>* unnamed_1, std::vector<cv::UMat>* unnamed_2, Result_void* ocvrs_return) {
		try {
	...
	void cv_detail_PairwiseSeamFinder_find_const_vectorLUMatGR_const_vectorLPointGR_vectorLUMatGR(cv::detail::PairwiseSeamFinder* instance, const std::vector<cv::UMat>* src, const std::vector<cv::Point>* corners, std::vector<cv::UMat>* masks, Result_void* ocvrs_return) {
		try {
			instance->find(*src, *corners, *masks);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_PaniniPortraitWarper_PaniniPortraitWarper_float_float_float(float scale, float A, float B, Result<cv::detail::PaniniPortraitWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::PaniniPortraitWarper*>, ocvrs_return);
	}
	...
	void cv_detail_PaniniWarper_PaniniWarper_float_float_float(float scale, float A, float B, Result<cv::detail::PaniniWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::PaniniWarper*>, ocvrs_return);
	}
	...
	void cv_detail_PlanePortraitWarper_PlanePortraitWarper_float(float scale, Result<cv::detail::PlanePortraitWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::PlanePortraitWarper*>, ocvrs_return);
	}
	...
	void cv_detail_PlaneWarper_PlaneWarper_float(float scale, Result<cv::detail::PlaneWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::PlaneWarper*>, ocvrs_return);
	}
	...
	void cv_detail_PlaneWarperGpu_PlaneWarperGpu_float(float scale, Result<cv::detail::PlaneWarperGpu*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::PlaneWarperGpu*>, ocvrs_return);
	}
	...
	void cv_detail_SeamFinder_find_const_vectorLUMatGR_const_vectorLPointGR_vectorLUMatGR(cv::detail::SeamFinder* instance, const std::vector<cv::UMat>* src, const std::vector<cv::Point>* corners, std::vector<cv::UMat>* masks, Result_void* ocvrs_return) {
		try {
			instance->find(*src, *corners, *masks);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_SphericalPortraitWarper_SphericalPortraitWarper_float(float scale, Result<cv::detail::SphericalPortraitWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::SphericalPortraitWarper*>, ocvrs_return);
	}
	...
	void cv_detail_SphericalWarper_SphericalWarper_float(float scale, Result<cv::detail::SphericalWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::SphericalWarper*>, ocvrs_return);
	}
	...
	void cv_detail_SphericalWarperGpu_SphericalWarperGpu_float(float scale, Result<cv::detail::SphericalWarperGpu*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::SphericalWarperGpu*>, ocvrs_return);
	}
	...
	void cv_detail_StereographicWarper_StereographicWarper_float(float scale, Result<cv::detail::StereographicWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::StereographicWarper*>, ocvrs_return);
	}
	...
	void cv_detail_TransverseMercatorWarper_TransverseMercatorWarper_float(float scale, Result<cv::detail::TransverseMercatorWarper*>* ocvrs_return) {
		try {
			...
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(Result<cv::detail::TransverseMercatorWarper*>, ocvrs_return);
	}
	...
	void cv_detail_VoronoiSeamFinder_find_const_vectorLUMatGR_const_vectorLPointGR_vectorLUMatGR(cv::detail::VoronoiSeamFinder* instance, const std::vector<cv::UMat>* src, const std::vector<cv::Point>* corners, std::vector<cv::UMat>* masks, Result_void* ocvrs_return) {
		try {
			instance->find(*src, *corners, *masks);
			Ok(ocvrs_return);
		} OCVRS_CATCH(Result_void, ocvrs_return);
	...
	void cv_detail_VoronoiSeamFinder_find_const_vectorLSizeGR_const_vectorLPointGR_vectorLUMatGR(cv::detail::VoronoiSeamFinder* instance, const std::vector<cv::Size>* size, const std::vector<cv::Point>* corners, std::vector<cv::UMat>* masks, Result_void* ocvrs_return) {
		try {
